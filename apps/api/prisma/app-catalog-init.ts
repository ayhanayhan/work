...
const defs:any[]=[
  {slug:'fixed-currency-prices',name:'Sabit Döviz Fiyatları',category:'Fiyatlandırma',summary:'Aktif para birimleri için ürün bazında sabit fiyat tanımlayın.',description:'Kur dönüşümü yerine ürün varyantı bazında TRY, USD, EUR ve mağazada aktif diğer para birimleri için sabit fiyat kullanın.',icon:'iconoir:coin',kind:'TOOL',integrationType:null,provider:null,basePrice:0,billingType:'FREE',isFeatured:false,sortOrder:15,settingsSchema:{mode:'toggle-only',marketplace:{usageGuide:'Uygulamayı kurun ve açık bırakın. Ürün düzenleme ekranında aktif para birimleri için sabit fiyat alanları görünür.'}}},
