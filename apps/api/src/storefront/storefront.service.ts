...
export class StorefrontService {
  ...
  private designSettings(store:any,locale?:string){
    ...
    const saved:any=this.localizeThemeNode(state?.design||legacyDesign||{},locale,store?.locale);
