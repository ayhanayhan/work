...
class sliderSlide extends HTMLElement {
  constructor() {
    super();
    this.slider = this.querySelectorAll('.ticarti-compare__container');
  ...
  updateSlider() {
    ...
    this.querySelectorAll('.ticarti-compare__container').forEach((item) => {
  ...
  resizeHandler(){
    ...
    if(fullwidth<=sliderWidth+20){
      this.querySelector('.ticarti-compare__buttons').classList.add('hide')
      this.querySelector('.ticarti-compare').classList.add('ticarti-compare--center');
    }
    else{
      this.querySelector('.ticarti-compare__buttons').classList.remove('hide');
      this.querySelector('.ticarti-compare').classList.remove('ticarti-compare--center');
    }

    this.querySelectorAll('.ticarti-compare__heading').forEach((item) => {
