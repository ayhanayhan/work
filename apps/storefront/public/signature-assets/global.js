console.log('Ticarti Shopify Theme. Version 3.4.0 shopify 2.0. https://themeforest.net/item/ticarti-multipurpose-shopify-theme/22559417')
...
class ticartiMasonry extends HTMLElement {
  constructor() {
    super();
  ...
  init() {
    ...
    this.msnry = new Masonry(this, {
      itemSelector: '.ticarti-masonry__item',
      columnWidth: '.ticarti-masonry-grid-sizer',
...
customElements.define('masonry-items', ticartiMasonry);

class ticartiSwiper extends HTMLElement {
  constructor() {
    super();
    this.swiper = false;
...
if (document.readyState === 'complete') {
  customElements.define('swiper-slider', ticartiSwiper);
}
else{
...
class mainSlider extends ticartiSwiper {
  constructor() {
    super();
...
class ListSpotlight extends ticartiSwiper {
  constructor() {
    super();
  }
  connectedCallback() {
...
class compareButton extends mediaButtonsEvent {
  constructor() {
    super();
    this.parent = this.closest('.ticarti-compare');
  ...
  deleteItem(){
    ...
    setTimeout(function(){
      ...
      _this.parent.querySelector('.ticarti-compare__count__number').innerHTML = _this.parent.querySelectorAll('.ticarti-compare__container')[0].children.length;
...
class ticartiSwiperReels extends HTMLElement {
  constructor() {
    super();
    this.swiper = false;
    this.classList.add('swiper-buttons-initialized');
...
customElements.define('swiper-reels', ticartiSwiperReels);
