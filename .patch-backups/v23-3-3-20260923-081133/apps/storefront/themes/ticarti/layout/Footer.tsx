...
export default function Footer({boot}:{boot:any}){
  ...
  <footer id={footerId} className={`footer top-spacing-none ${String(footer.layoutClass||'')} ${sectionClass} section-background section-background--medium`} data-section-name="wokiee-footer" data-theme-skin={skinSlug} style={{'--color-section-background':footer.backgroundColor||footer.color_background||undefined} as any}>
