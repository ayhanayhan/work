...
class sliderSlide extends HTMLElement {
  constructor() {
    super();
    this.slider = this.querySelectorAll('.signature-compare__container');
  ...
  updateSlider() {
    ...
    this.querySelectorAll('.signature-compare__container').forEach((item) => {
  ...
  resizeHandler(){
    ...
    if(fullwidth<=sliderWidth+20){
      this.querySelector('.signature-compare__buttons').classList.add('hide')
      this.querySelector('.signature-compare').classList.add('signature-compare--center');
    }
    else{
      this.querySelector('.signature-compare__buttons').classList.remove('hide');
      this.querySelector('.signature-compare').classList.remove('signature-compare--center');
    }

    this.querySelectorAll('.signature-compare__heading').forEach((item) => {
