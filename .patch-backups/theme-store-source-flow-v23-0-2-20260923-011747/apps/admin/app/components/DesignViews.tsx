...
export default function DesignViewRouter({page,data,sid,req,reload}:Props){
  ...
  async function saveAll(){
    ...
    try{
      ...
      const nextDesign={...design,general:{...(design?.general||{}),skinSlug:targetSkin,skin:targetSkin,themeBundleSkinSlug:targetSkin,themeBundleSectionsSkinSlug:targetSkin,themeBundleVersion:'v22.9.0'}};
