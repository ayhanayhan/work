...
function normalizeDesign(raw:any,{trustStore=false}:{trustStore?:boolean}={}){
 ...
 return {
   ...
   general:{...(source.general||{}),...(merged.general||{}),...(candidate.general||{}),themeName,skinSlug:skin.slug,skin:skin.slug,themeBundleSkinSlug:skin.slug,themeBundleVersion:'v23.0.3'},
...
export default function StorefrontGate({children}:{children:React.ReactNode}){
 ...
 else {sections=sourceSections;sectionsSource='source-fallback-empty-store'}
