...
export default function ThemeHead({design,children}:{design:any;children:React.ReactNode}){
 ...
 const vars=useMemo(()=>({...ticartiCssVariables(settings),...(exactLingerie?lingerieCssVariables:{}),...(explicit?ticartiCssVariables(settings):{})}) as any,[settings,explicit,exactLingerie]);
