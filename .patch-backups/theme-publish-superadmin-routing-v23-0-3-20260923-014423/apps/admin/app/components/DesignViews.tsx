...
export default function DesignViewRouter({page,data,sid,req,reload}:Props){
  ...
  async function saveAll(){
    ...
    try{
      ...
      const nextDesign={...design,general:{...(design?.general||{}),skinSlug:targetSkin,skin:targetSkin,themeBundleSkinSlug:targetSkin,themeBundleSectionsSkinSlug:targetSkin,themeBundleVersion:'v23.0.2'}};
      ...
      if(editorSourceMode==='demo'){const url=new URL(window.location.href);url.searchParams.set('sourceMode','edit');window.location.replace(url.toString());return;}
