...
export default function ThemeHead({design,children}:{design:any;children:React.ReactNode}){
 ...
 useEffect(()=>{
   ...
   const root=document.documentElement;const hadApple=root.classList.contains('apple-device');if(exactLingerie)root.classList.add('apple-device');document.body.dataset.ticartiTheme='ticarti';document.body.dataset.ticartiSkin=skin.slug;
 ...
 },[cssVarsText,exactLingerie,skin.slug]);
 ...
 return <div className="ticarti-theme" data-theme-id="ticarti" data-theme-name={String((settings as any).themeName||'Ticarti')} data-theme-skin={skin.slug}>
