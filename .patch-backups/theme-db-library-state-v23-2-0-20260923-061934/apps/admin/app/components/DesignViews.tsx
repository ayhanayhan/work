...
export default function DesignViewRouter({page,data,sid,req,reload}:Props){
  ...
  async function saveAll(){
    ...
    try{
      ...
      const nextDesign={...design,general:{...cleanGeneral,skinSlug:targetSkin,skin:targetSkin,themeBundleSkinSlug:targetSkin,themeBundleSectionsSkinSlug:targetSkin,themeBundleVersion:'v23.1.1'}};
      ...
      if(!result?.ok||result?.saveMode!=='ATOMIC_THEME_EDITOR_V23_1_2')throw new Error('Tema kayıt servisi güncel değil. commerce-api v23.1.2 deploy edilmelidir.');
