...
export class MerchantController {
  ...
  @RequirePermission('content.read')
  @Get('design/debug') designDebug(@CurrentTenant() t:string,@Query('storeId') s:string){ return this.svc.designDebug(t,s); }
  @RequirePermission('content.read')
  @Get('design/settings') designSettings(@CurrentTenant() t:string,@Query('storeId') s:string){ return this.svc.designSettings(t,s); }
  @RequirePermission('content.manage')
  @Patch('design/settings') designSettingsSave(@CurrentTenant() t:string,@Body() b:any){ return b?.themeEditorSave===true?this.svc.saveThemeEditorSnapshot(t,b.storeId,b):this.svc.updateDesignSettings(t,b.storeId,b); }
  @RequirePermission('content.read')
