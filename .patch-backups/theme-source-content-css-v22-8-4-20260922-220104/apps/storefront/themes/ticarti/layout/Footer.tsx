...
export default function Footer({boot}:{boot:any}){
  ...
  const storeLinks:LinkItem[]=normalizedStoreLinks.length?normalizedStoreLinks:(footerMenuLinks.length?footerMenuLinks:(categories.length?categories:fallbackStoreLinks));
