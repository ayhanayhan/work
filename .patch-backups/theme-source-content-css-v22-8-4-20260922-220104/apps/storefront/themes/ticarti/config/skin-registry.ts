...
export function mergeSkinDesign(design:any,skin:TicartiSkin){const base=skin?.design||{};const current=design||{};return { ...current, general:{...(base.general||{}),...(current.general||{}),skinSlug:skin.slug,skin:skin.slug,skinName:skin.name,themeSourceVersion:'ticarti-skins-v2'}, header:{...(base.header||{}),...(current.header||{})}, footer:{...(base.footer||{}),...(current.footer||{})}, products:{...(base.products||{}),...(current.products||{})} }}
