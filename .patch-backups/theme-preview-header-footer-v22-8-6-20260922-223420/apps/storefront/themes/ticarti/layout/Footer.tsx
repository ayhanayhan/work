...
export default function Footer({boot}:{boot:any}){
  ...
  const store=boot?.store||{};const design=boot?.design||{};const skin=resolveTicartiSkin(design);const sourceFooter=skin?.design?.footer||{};const footer={...sourceFooter,...(design.footer||{})};
