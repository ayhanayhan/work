...
export class MerchantService {
  ...
  async themeCatalog(tenantId:string,storeId:string){
    ...
    const features:any=sub?.plan?.features||{};
    const hasSkinRule=Object.prototype.hasOwnProperty.call(features,'themeSkins');
    const rawSkinAccess:any[]=hasSkinRule?(Array.isArray(features.themeSkins)?features.themeSkins:[]):['demo-1'];
