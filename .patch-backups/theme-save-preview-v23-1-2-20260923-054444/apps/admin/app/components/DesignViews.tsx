...
export default function DesignViewRouter({page,data,sid,req,reload}:Props){
  ...
  async function saveAll(){
    ...
    try{
      ...
      const result=await req('/admin/theme-editor/save',{method:'POST',body:JSON.stringify({storeId:sid,themeId:String(targetTheme.id),skinSlug:targetSkin,pageKey:'home',design:nextDesign,sections:sectionPayload,menus})});
      if(!result?.ok)throw new Error('Tema kaydı tamamlanamadı.');
