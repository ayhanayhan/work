...
export default function DesignViewRouter({page,data,sid,req,reload}:Props){
  ...
  function openThemeEditor(theme:any,skinSlug:string){window.location.href=`/design-content?editor=1&themeId=${encodeURIComponent(String(theme.id))}&skinSlug=${encodeURIComponent(String(skinSlug))}`}
