...
export class MerchantService {
  ...
  async activateTheme(tenantId:string,storeId:string,themeId:string,options:any={}){
    ...
    const nextDesign=preserveThemeSettings?{general:{...(themeDesign.general||{}),...currentDesign.general},header:{...(themeDesign.header||{}),...currentDesign.header},footer:{...(themeDesign.footer||{}),...currentDesign.footer},products:{...(themeDesign.products||{}),...currentDesign.products}}:{general:{...(themeDesign.general||{})},header:{...(themeDesign.header||{})},footer:{...(themeDesign.footer||{})},products:{...(themeDesign.products||{})}};
