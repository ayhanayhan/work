...
function normalizeDesign(raw:any,{trustStore=false}:{trustStore?:boolean}={}){
 ...
 return {
   ...
   general:{...(source.general||{}),...(merged.general||{}),...(candidate.general||{}),themeName,skinSlug:skin.slug,skin:skin.slug,themeBundleSkinSlug:skin.slug,themeBundleVersion:'v23.0.7'},
