...
function withBundleMarker(design:any,skinSlug:string){const next=clone(design||{});next.general={...(next.general||{}),skinSlug,skin:skinSlug,themeBundleSkinSlug:skinSlug,themeBundleVersion:'v22.8.6'};return next}
...
function normalizeDesign(raw:any){
 ...
 return {
   ...source,...merged,
   general:{...(source.general||{}),...(merged.general||{}),themeName,skinSlug:skin.slug,skin:skin.slug,themeBundleSkinSlug:skin.slug,themeBundleVersion:'v22.8.6'},
