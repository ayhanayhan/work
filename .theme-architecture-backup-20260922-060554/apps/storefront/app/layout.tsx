...
export default async function Layout({children}:{children:React.ReactNode}){
  ...
  return <html lang={locale.split('-')[0]||'tr'} dir={rtl?'rtl':'ltr'}><head>{!platform&&<><link data-ticarti-source-theme="1" rel="stylesheet" href="/signature-assets/base.css"/><link rel="stylesheet" href="/signature-assets/swiper-bundle.min.css"/><link rel="stylesheet" href="/signature-assets/component-swiper-slider.css"/><link rel="stylesheet" href="/signature-assets/section-header.css"/><link rel="stylesheet" href="/signature-assets/component-sticky-header.css"/><link rel="stylesheet" href="/signature-assets/component-fixed-header.css"/><link rel="stylesheet" href="/signature-assets/component-predictive-search.css"/><link rel="stylesheet" href="/signature-assets/component-localization-form.css"/><link rel="stylesheet" href="/signature-assets/component-product-card.css"/><link rel="stylesheet" href="/signature-assets/component-product-card-list.css"/><link rel="stylesheet" href="/signature-assets/component-price.css"/><link rel="stylesheet" href="/signature-assets/component-facets.css"/><link rel="stylesheet" href="/signature-assets/component-facets--horizontal.css"/><link rel="stylesheet" href="/signature-assets/component-facets--vertical.css"/><link rel="stylesheet" href="/signature-assets/section-main-product.css"/><link rel="stylesheet" href="/signature-assets/component-media-gallery.css"/><link rel="stylesheet" href="/signature-assets/component-featured-tabs.css"/><link rel="stylesheet" href="/signature-assets/component-cart-items.css"/><link rel="stylesheet" href="/signature-assets/section-blog-post.css"/><link rel="stylesheet" href="/signature-assets/section-blog-post-article.css"/><link rel="stylesheet" href="/signature-assets/section-footer.css"/></>}</head><body>{organization&&<script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(organization).replace(/</g,'\\u003c')}}/>}{platform?children:<StorefrontGate>{children}</StorefrontGate>}</body></html>;
}
