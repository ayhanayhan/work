...
import { ticartiSourceDesign, ticartiSourceHomePreset } from '../theme-presets/ticarti-source-preset';
...
export class MerchantService {
  ...
  async activateTheme(tenantId:string,storeId:string,themeId:string,options:any={}){
    ...
    const preset:any[]=isTicartiTheme?ticartiSourceHomePreset():(Array.isArray(cfg.homePreset)?cfg.homePreset:[]);
    const themeDesign:any=isTicartiTheme?ticartiSourceDesign:(cfg.design||{});
