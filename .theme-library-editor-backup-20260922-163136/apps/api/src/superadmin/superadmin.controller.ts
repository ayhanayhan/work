...
export class SuperAdminController {
  ...
  @Post('plans/:id/theme-skins') setPlanThemeSkins(@Param('id') id:string,@Body() b:any){ return this.svc.setPlanThemeSkins(id,b); }
  ...
  @Post('themes/import') importThemes(@Body() b:any){ return this.svc.importThemes(b); }
  @Patch('themes/:id') updateTheme(@Param('id') id:string,@Body() b:any){ return this.svc.updateTheme(id,b); }
  @Delete('themes/:id') deleteTheme(@Param('id') id:string,@Query('force') force?:string){ return this.svc.deleteTheme(id,force==='true'); }
  ...
  @Delete('tenants/:tenantId/themes/:themeId/grant') revokeTheme(@Param('tenantId') tenantId:string,@Param('themeId') themeId:string){ return this.svc.revokeTheme(tenantId,themeId); }
